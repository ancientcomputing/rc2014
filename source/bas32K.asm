...
; 2. Use RAM-based vector table for interrupts and RST instructions for better
...
MONOUT: 
        RST	    08H		; We are using the RST instruction to input a character
        RET			; in GETINP, so why not do the same for output?
; bc        JP      $0008           ; output a char
